...
const NavBar = () => {
  ...
  <Navbar.Brand style={{letterSpacing: "0.2em",fontSize:'1.5em'}} className="navbar-brand px-lg-5 px-md-5" href="/Login"> Colleagues</Navbar.Brand>
  <Navbar.Toggle aria-controls="responsive-navbar-nav" />
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="ml-auto px-lg-2">
    <Nav.Link active href="/"  >Colleagues List </Nav.Link>
